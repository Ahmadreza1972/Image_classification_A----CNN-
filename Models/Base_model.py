...
class BaseModle:
    def __init__(self, config, model_name):
        ...
        self._conv_layers_arch=self._config.hyperparameters["conv_Arch"]
        self._fc__Arch=self._config.hyperparameters["fc__Arch"]
        
        # set parameters
        self._num_classes=self._config.model_parameters["num_classes"]
        self._device=self._config.model_parameters["device"]
        self._input_chanels=self._config.model_parameters["input_chanels"]
